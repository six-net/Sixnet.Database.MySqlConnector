...
namespace EZNEW.Repository.Sys
{
    ...
    public class AuthorityRepository : DefaultAggregationRepository<Authority, AuthorityEntity, IAuthorityDataAccess>, IAuthorityRepository
    {
        ...
        public void RemoveAuthorityByGroup(IEnumerable<AuthorityGroup> groups, ActivationOption activationOption = null)
        {
        ...
        public void RemoveAuthorityByGroup(IQuery query, ActivationOption activationOption = null)
        {
            if (query == null)
            {
                return;
